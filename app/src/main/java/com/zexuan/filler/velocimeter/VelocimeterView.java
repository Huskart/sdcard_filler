package com.zexuan.filler.velocimeter;
...
import com.zexuan.filler.R;
import com.zexuan.filler.velocimeter.painter.bottom.BottomVelocimeterPainter;
import com.zexuan.filler.velocimeter.painter.bottom.BottomVelocimeterPainterImp;
import com.zexuan.filler.velocimeter.painter.digital.Digital;
import com.zexuan.filler.velocimeter.painter.digital.DigitalBlurImp;
import com.zexuan.filler.velocimeter.painter.digital.DigitalImp;
import com.zexuan.filler.velocimeter.painter.inside.InsideVelocimeterMarkerPainter;
import com.zexuan.filler.velocimeter.painter.inside.InsideVelocimeterMarkerPainterImp;
import com.zexuan.filler.velocimeter.painter.inside.InsideVelocimeterPainterImp;
import com.zexuan.filler.velocimeter.painter.needle.LineBlurPainter;
import com.zexuan.filler.velocimeter.painter.needle.NeedlePainter;
import com.zexuan.filler.velocimeter.painter.needle.NeedlePainterImp;
import com.zexuan.filler.velocimeter.painter.progress.BlurProgressVelocimeterPainter;
import com.zexuan.filler.velocimeter.painter.progress.ProgressVelocimeterPainter;
import com.zexuan.filler.velocimeter.painter.progress.ProgressVelocimeterPainterImp;
import com.zexuan.filler.velocimeter.painter.velocimeter.InternalVelocimeterPainter;
import com.zexuan.filler.velocimeter.painter.velocimeter.InternalVelocimeterPainterImp;
...
public class VelocimeterView extends View {
    ...
    public void setTargetType(int type) {
        ...
        int total = (int) (blockSize * totalBlocks / (1024 * 1024));
        units = "   /  " + (total) + " (Mb)";
        digitalPainter.setUnit(units);
        digitalBlurPainter.setUnit(units);
        invalidate();
    }
...
//        }
    ...
    private void updateValueNeedle(float value) {
        ...
        digitalPainter.setValue(value, type);
        digitalBlurPainter.setValue(value, type);
    }
